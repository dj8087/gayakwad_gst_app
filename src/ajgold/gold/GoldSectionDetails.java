 ...
 * @author admin
 */
public class GoldSectionDetails extends javax.swing.JDialog {

    /** Creates new form GoldSection */
    public GoldSectionDetails(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GoldSectionDetails dialog = new GoldSectionDetails(new javax.swing.JFrame(), true);
