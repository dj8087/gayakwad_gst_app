...
CustomerObj[] co=null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        CustomerObj wo = (CustomerObj) jComboBox2.getSelectedItem();
          ...
          EntryAmount ea = new EntryAmount(parent, true);
            ea.setAmount(Float.parseFloat(df.format((wo.gold_ac))));
            ea.setVisible(true);
            if(ea.amount==0){
                return;
            }
            if(Math.abs(ea.amount)>Math.abs(wo.gold_ac)){
        ...
        if(selectedAc==1)
         ...
         try{
             if(selectedAc==1)
                con.executeUpdate("update customer_mst set money_ac="+wo.money_ac+" where cid="+wo.cid);
             else
                 con.executeUpdate("update customer_mst set advance="+wo.advance+" where cid="+wo.cid);

             wo.gold_ac=wo.gold_ac-(ea.amount);
             con.executeUpdate("update customer_mst set gold_ac="+wo.gold_ac+" where cid="+wo.cid);
    ...
    private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox2ItemStateChanged
        ...
        if(wo.gold_ac<0){
            float g = Math.abs(wo.gold_ac);
                ...
                jLabel4.setText(""+df.format(g)+" gm");
                 jLabel4.setForeground(Color.red);
        }else{
            jLabel4.setText(""+df.format((wo.gold_ac))+" gm");
            jLabel4.setForeground(Color.black);
        }

        if(wo.money_ac<0){
            jLabel6.setForeground(Color.red);
            jLabel6.setText(""+Math.abs(wo.money_ac));
        }else{
            ...
            try {
                ...
                try{
                 ...
                 if(jComboBox1.getSelectedIndex()==DEBIT)
                     adv = (adv)*(-1);
                CustomerObj wo = ((CustomerObj) jComboBox2.getSelectedItem());
                con.executeUpdate("update customer_mst set advance=advance+"+adv+" where cid="+wo.cid);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            EntryAmount ea = new EntryAmount(parent, true);
            ea.setAmount(wo.money_ac);
            ea.setVisible(true);
            if(ea.amount==0){
                return;
            }
            System.out.println("EA Amount:"+ea.amount);
            if(Math.abs(ea.amount)>Math.abs(wo.money_ac)){
                JOptionPane.showMessageDialog(parent, "Wrong Entry!");
                return;
            }
            float gold = wo.money_ac/rate;
            System.out.println("G Old:"+wo.gold_ac);
      //      gold*=1000;
            wo.gold_ac += gold;
            System.out.println("G New:"+wo.gold_ac);
            wo.money_ac=wo.money_ac-ea.amount;
        }
        else{
            EntryAmount ea = new EntryAmount(parent, true);
        ...
        System.out.println("[amt:"+ea.amount+" gm]");
            float gold = ea.amount/rate;

        System.out.println("[gld:"+gold+" gm]");
            wo.gold_ac+=(gold);
